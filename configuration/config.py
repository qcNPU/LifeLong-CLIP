...
def base_parser():
    ...
    parser.add_argument("--gpt_dir", type=str, default="/home/qc/project/LifeLong-CLIP/datasets/gpt/gpt_data", help="Model name")
    parser.add_argument("--batchsize", type=int, default=64, help="batch size")
    parser.add_argument("--test_batchsize", type=int, default=16, help="batch size")
    parser.add_argument("--num_sampled_pcls",type=int,default=32,help="The number of workers")
